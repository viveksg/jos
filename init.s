...
.LFB3:
	...
	movaps	%xmm7, 192(%rsp)
.L18:
	.stabn	68,0,83,.LM31-.LFBB4
.LM31:
	movq	%fs:40, %rax
	movq	%rax, 24(%rsp)
	xorl	%eax, %eax
	.stabn	68,0,86,.LM32-.LFBB4
.LM32:
	leaq	224(%rsp), %rax
	.stabn	68,0,87,.LM33-.LFBB4
.LM33:
	movl	%esi, %edx
	movq	%rdi, %rsi
	leaq	.LC5(%rip), %rdi
